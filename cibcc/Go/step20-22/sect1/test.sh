...
assert 8 'int main(){return 2+2*3;}'
assert 6 'int main(){return 16/2-2;}'
...
assert 12 'int main(){return arg(6);}'
...
assert 55 'int main(){return fib(9);} int fib(int x){if(x<=1) return 1; fib(x-1)+fib(x-2);}'
